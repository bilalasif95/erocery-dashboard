...
import { CategoryDetails_category_backgroundImage } from "../../types/PageDetails";
import { FormData } from "../PageUpdatePage";
...
const PageImage: React.FC<CategoryBackgroundProps> = props => {
