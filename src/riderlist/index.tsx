...
import RiderPage, { MenuSection } from "./RiderPage";
...
export const configurationMenuUrl = "/riderlist/";

export const RiderListSection: React.FC = () => {
...
export default RiderListSection;
