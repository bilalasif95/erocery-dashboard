...
const staffMemberAddMutation = gql`
  mutation StaffMemberAdd($name: String!, $city: String!, $phone: String!,$password:String!,$cnic:String!,$shop_id:String!) {
    riderCreate(input: { name: $name, city: $city,phone:$phone,password:$password,cnic:$cnic,shopid:$shop_id }) {
      rider {
        name
        city
      }
