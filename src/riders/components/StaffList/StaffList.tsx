...
const StaffList = withStyles(styles, { name: "StaffList" })(
  ({ classes, staffMembers }: StaffListProps) => {
    ...
    const showRiderDetails = (riderId) => {
      navigate(staffMemberDetailsPath(riderId));
    };
    return (
      <Card>
              ...
              {renderCollection(staffMembers, (staffMember) => (
                <TableBody>
                  <TableRow>
                    <TableCell
                      padding="dense"
                      onClick={() => showRiderDetails(staffMember.id)}
                    >
                    ...
                    <TableCell padding="dense">Order Assigned</TableCell>
                  </TableRow>
                </TableBody>
              ))}
            </Table>
        ...
        <TabPanel value={value} index={1}>
          <div className={classes.tableContainer}>
            <Table>
              ...
              <TableBody>
                <TableRow>
                  <TableCell padding="dense">000001234</TableCell>
                  <TableCell padding="dense">04-07-2020</TableCell>
                  <TableCell padding="dense">3rd Floor</TableCell>
                  <TableCell padding="dense">Rs. 1200.00</TableCell>
                  <TableCell padding="dense">
                    <button className={classes.btnPending}>Pending</button>
                  </TableCell>
                  <TableCell padding="dense">Bilal Asif</TableCell>
                  <TableCell
                    padding="dense"
                    onClick={() => navigate(orderUrl("1234"))}
                  >
